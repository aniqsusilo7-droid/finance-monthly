  ...
  return (
    <div className="space-y-4 sm:space-y-6 animate-fadeIn">
      ...
      <div className="glass-panel p-5 sm:p-8 rounded-2xl relative overflow-hidden group border-l-4 border-indigo-500">
        <h3 className="text-lg sm:text-xl font-bold text-white mb-5 flex items-center gap-2 uppercase tracking-tight">
          <span className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-indigo-900/50 flex items-center justify-center text-indigo-400 text-xs sm:text-sm font-black border border-indigo-500/20">1</span>
          Pendapatan
        </h3>
      ...
      {/* Potongan Section */}
      <div className="glass-panel p-5 sm:p-8 rounded-2xl shadow-lg relative overflow-hidden border-l-4 border-rose-600">
        <h3 className="text-lg sm:text-xl font-bold text-white mb-5 flex items-center gap-2 uppercase tracking-tight">
           <span className="w-6 h-6 sm:w-8 sm:h-8 rounded-lg bg-rose-900/50 flex items-center justify-center text-rose-400 text-xs sm:text-sm font-black border border-rose-500/20">2</span>
           Potongan
        </h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <div className="flex flex-col gap-1.5">
      ...
      <div className="relative overflow-hidden rounded-3xl shadow-2xl">
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-700 to-blue-900"></div>
        <div className="absolute top-0 right-0 p-8 opacity-10 transform translate-x-10 -translate-y-10">
            <div className="w-60 h-60 rounded-full bg-white blur-[80px]"></div>
        </div>
