                      ...
                      return (
                        <tr key={entry.id} className="hover:bg-white/5 transition-colors group">
                           ...
                           <td className="px-6 py-4 min-w-[450px]">
                              <div className="bg-slate-950 border border-slate-800 rounded-lg p-2.5 shadow-inner flex items-center">
                                 <input 
                                    type="text"
                                    value={entry.purpose} 
                                    onChange={(e) => updateEntry(entry.id, 'purpose', e.target.value)}
                                    placeholder="Type purpose here..."
                                    className="w-full bg-transparent text-sm text-white font-bold outline-none placeholder-slate-600"
                                 />
                              </div>
                           </td>
